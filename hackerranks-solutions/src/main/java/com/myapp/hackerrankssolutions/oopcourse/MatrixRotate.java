package com.myapp.hackerrankssolutions.oopcourse;
...
public class MatrixRotate {
    ...
    public static void rotate90(double[][] matrix) {
        double[][] tempMatrix = generateMatrix(matrix.length);
        int cloumIndex = matrix.length-1;
        for (int i = 0; i < matrix.length; i++) {
            for (int j = 0; j < matrix.length; j++) {
                matrix[i][cloumIndex-j] = tempMatrix[i][j];
            }
        }
    }
    ...
    public static void rotate180(double[][] matrix) {
        ...
        for (int i = 0; i < matrix.length; i++) {
            for (int j = 0; j < matrix.length; j++) {
                matrix[cloumIndex-i][cloumIndex-j] = tempMatrix[i][j];
            }
        }
    }
    ...
    public static void rotate270(double[][] matrix) {
        ...
        for (int i = 0; i < matrix.length; i++) {
            for (int j = 0; j < matrix.length; j++) {
                matrix[cloumIndex-i][j] = tempMatrix[i][j];
            }
        }
    }
}